...
map.getView().fit([-6094163.387265, -2968851.784258, -4928622.046841, -2454115.619277], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapas de Repetidoras</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (363 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Mapa desenvolvido para verificar a distância entre meu QTH e repetidoras próximas, posicionadas exatamente onde suas torres estão localizadas. Utilizei o modelo de propagação Longley-Rice, com as especificações da antena OSJ e de um rádio portátil de 5W. Também inclui uma camada de visibilidade, mostrando até onde consigo ter linha de visão a partir do meu QTH.';
            }
